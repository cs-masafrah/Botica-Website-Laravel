...
return [
    'admin' => [
        ...
        'admin' => [
            'system' => [
                'reels'        => 'ريلز',
                'reels-info'   => 'إعدادات نظام الريلز',

                'settings'      => 'الإعدادات العامة',
                'settings-info' => 'تهيئة إعدادات الريلز وسلوكها',

                'general'      => 'إعدادات الريلز',
                'general-info' => 'الإعدادات العامة لوحدة الريلز',

                'fields' => [
                    'enable'         => 'تفعيل الريلز',
                    'max-duration'   => 'أقصى مدة للفيديو (ثواني)',
                    'allow-likes'    => 'السماح بالإعجابات',
                    'allow-comments' => 'السماح بالتعليقات',
                    'items-per-page' => 'عدد الريلز في الصفحة',
                ],
            ],
        ],
