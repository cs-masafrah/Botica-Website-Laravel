<v-product-list :errors="errors">
    <x-admin::shimmer.settings.themes.product-list />
</v-product-list>
            ...
            <div class="p-4 bg-white rounded box-shadow dark:bg-gray-900">
                <div class="mb-2.5 flex items-center justify-between gap-x-2.5">
                    <div class="flex flex-col gap-1">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('admin::app.settings.themes.edit.product-list')
                        </p>

                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('admin::app.settings.themes.edit.product-list-description')
                        </p>
                    </div>
                </div>
                ...
                >
                    <img
                        ...
                        alt="@lang('admin::app.settings.themes.edit.product-list')"
                    >
