        ...
        DB::table('theme_customizations')
            ->insert([
                ...
                [
                    ...
                    'name'       => trans('installer::app.seeders.shop.theme-customizations.product-by-brand.name', [], $defaultLocale),
                    'sort_order' => 3,
                    'status'     => 1,
                    'channel_id' => 1,
                    'created_at' => $now,
                ...
                [
                    'id'         => 14,
                    'type'       => 'product_list',
                    'name'       => trans('installer::app.seeders.shop.theme-customizations.product-list.name', [], $defaultLocale),
                    'sort_order' => 14,
                    'status'     => 1,
                    'channel_id' => 1,
                    'created_at' => $now,
