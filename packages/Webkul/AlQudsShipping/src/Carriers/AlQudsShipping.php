...
namespace Webkul\AlQudsShipping\Carriers;

use Webkul\Checkout\Facades\Cart;
use Webkul\Checkout\Models\CartShippingRate;
use Webkul\Shipping\Carriers\AbstractShipping;

class AlQudsShipping extends AbstractShipping
{
    /**
     * Shipping method carrier code.
     */
    protected $code = 'alqudsshipping';

    /**
     * Shipping method code.
     */
    protected $method = 'alqudsshipping_alqudsshipping';
    ...
    public function calculate()
    {
        ...
        $object->carrier = 'alqudsshipping';
        $object->carrier_title = $this->getConfigData('title');
        $object->method = 'alqudsshipping_alqudsshipping';
